...
@RestController //we use to respond with text or JSON
...
public class HomeController {
	...
	// Annotation (similar to SpringBootApp and RC above)
		...
		// by default requests are GET methods, specify to POST for RESTful routing principles when sending sensitive information
		public String hello() {
